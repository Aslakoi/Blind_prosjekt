...
void loop() {
  ...
  */
  ...
  case 2: //vibrasjon på en motor
    ledcWrite(1, 0); 
    motor1_Intensity = map(motor1_Intensity, RELIABILITY_THRESHOLD, SAFE_DISTANCE, 255, 0);
    ledcWrite(0, motor1_Intensity);
    break;
  case 3: // vibrasjon på en motor
    ledcWrite(0, 0);
    motor2_Intensity = map(motor2_Intensity, RELIABILITY_THRESHOLD, SAFE_DISTANCE, 255, 0);
